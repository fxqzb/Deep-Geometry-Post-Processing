...
from util.mylogging import init_logging, make_logging_dir
...
def parse_args():
    ...
    parser.add_argument('--config', default='./config/multi_scale.yaml')
...
if __name__ == '__main__':
    ...
    net_G, net_G_ema, opt_G, sch_G \
        = get_model_optimizer_and_scheduler(opt) # opt means optimizer, sch means lr
